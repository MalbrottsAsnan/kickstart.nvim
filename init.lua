...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>lg'] = { name = 'Dont forget the go to commands!', _ = 'which_key_ignore' },
        ['<leader>lgg'] = { name = ' gd (Definition), gr (References)', _ = 'which_key_ignore' },
        ['<leader>lgG'] = { name = 'gI (Implementation), gD (Declaration)', _ = 'which_key_ignore' },
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>d5', dap.continue, { desc = 'Debug: Start/Continue' })
      vim.keymap.set('n', '<leader>d4', dap.terminate, { desc = 'Debug: Stop' })
      ...
      vim.keymap.set('n', '<leader>d7', dap.toggle_breakpoint, { desc = 'Debug: Toggle breakpoint' })
      ...
      vim.keymap.set('n', '<leader>F', function()
        ...
        for i = 1, 12, 1 do
          output = vim.api.nvim_exec2('map <F' .. i .. '>', { output = true })['output']

          if output:find 'No mapping found' == nil then
            mappings = mappings .. '\n' .. output
            count = count + 1
          end

          output = vim.api.nvim_exec2('map <s-F' .. i .. '>', { output = true })['output']
        ...
        vim.notify(interlude_pre .. count .. interlude_aft .. mappings)
      end, { desc = '[F]unctional key mappings' })
    end,
  },
  {
  ...
  { -- Autocompletion
    ...
    config = function()
      --  INFO: Friendly snippet implementation
      ...
      cmp.setup {
        ...
        --  INFO: Added nice borders and ghost text
        window = {
